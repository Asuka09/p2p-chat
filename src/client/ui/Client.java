...
public class Client extends JFrame {
	...
	public Client() {
		...
		btnLogon = new JButton("Login"); // “登录”按钮
...
//					clientChannel = SocketChannel.open();               by jyc
...
//				            String serverReply=charset.decode(recvBuff).toString();
				            String serverReply="[{\"name\":\"jyc\",\"id\":\"1\",\"ip\":\"192.168.1.208\"}]";
//				            // 账号密码错误
...
//				            }
					...
					} else if (btnLogon.getText().equals("Exit")) {
...
//					clientChannel.close();
		...
		scrollPaneOnlineUsers.setViewportBorder(
				new TitledBorder(null, "Online User", TitledBorder.LEADING, TitledBorder.TOP, null, null));
