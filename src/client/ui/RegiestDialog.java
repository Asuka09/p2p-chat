...
public class RegiestDialog extends JDialog {
	...
	public RegiestDialog(JFrame parentFrame) {
		...
		lblNewLabel.setBounds(20, 10, 123, 15);
		contentPanel.add(lblNewLabel);

		JLabel lblNewLabel_1 = new JLabel("Password:");
		lblNewLabel_1.setBounds(20, 35, 123, 15);
		contentPanel.add(lblNewLabel_1);
		
		JLabel lblNewLabel_2 = new JLabel("Confirm Password:");
//		lblNewLabel_2.setHorizontalAlignment(SwingConstants.TRAILING); 不知道在干啥 by Asuka
		lblNewLabel_2.setBounds(20, 60, 123, 15);
		
		contentPanel.add(lblNewLabel_2);
        
		textFieldUserName = new JTextField();
		textFieldUserName.setBounds(169, 7, 135, 21);
		contentPanel.add(textFieldUserName);
		textFieldUserName.setColumns(10);

		passwordField = new JPasswordField();
		passwordField.setBounds(169, 32, 135, 21);
		contentPanel.add(passwordField);

		passwordFieldCheck = new JPasswordField();
		passwordFieldCheck.setBounds(169, 57, 135, 21);
